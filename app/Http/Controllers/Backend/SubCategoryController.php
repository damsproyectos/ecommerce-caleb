...
class SubCategoryController extends Controller
{
    ...
    {
        //dd($request->all()); *****Se utiliza para obtener todos los datos; pruebas
        $request->validate([
            'category' => ['required'],
    ...
    {
        //dd($request->all()); ****Prueba de envío de datos a la base de datos
        $request->validate([
            'category' => ['required'],
    ...
    {
        //dd($request->all()); ***** Pruebaas de Volcamiento de datoss
