@php
    ...
    //dd($categories);*****Realizo pruebas de conexión con la base de datos para obtener todas las categorías.
    $categories = \App\Models\Category::where('status', 1) //estos codigos siguientes son la logica para mostrar la categoría - subcategoría o childcategoría si el estado está activo  o inactivo
